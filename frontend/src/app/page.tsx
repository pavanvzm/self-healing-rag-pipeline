    ...
    <div className="group card-hover p-5">
      ...
      {trend && (
        <div className="mt-3 flex items-center gap-1.5 text-xs">
          <TrendingUp className={`h-3.5 w-3.5 ${trend === "up" ? "text-success" : "text-danger rotate-180"}`} />
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <StatCard
              ...
              sub="Score across all queries"
              icon={Shield}
              trend="up"
              color="bg-success/10 text-success"
            />
            <StatCard
              title="Avg Healing Iterations"
              value={summary.avg_healing_iterations.toFixed(1)}
              sub="Per query"
              icon={RefreshCw}
